  ...
  return (
    <Container>
      ...
      <Form onSubmit={this.handleSubmit}>
        <h3>Sign Up</h3>
        <Input placeholder="Institute Name" name="instName" value={this.state.value} onChange={this.handleName} required autocomplete/>
        <Input type="email" placeholder="Email" name="instEmail" value={this.state.value} onChange={this.handleEmail} required autocomplete/>
        <Input type="password" placeholder="Password" name="instPass" value={this.state.value} onChange={this.handlePass} required autocomplete/>
        <Input type="password" placeholder="Confrim Password" name="instConPass" value={this.state.value} onChange={this.handleConPass} required autocomplete/>
        
        <ContainerBox>
          <StyledSelect value={this.state.value} onChange={this.handleCountry} required>
            <Option>{this.state.ctry ? this.state.ctry : "Select Country"}</Option>
        ...
        <ContainerBox>
          ...
          <Option>{this.state.ste ? this.state.ste : "Select State"}</Option>
        ...
        <ContainerBox>
          ...
          <Option>{this.state.dist ? this.state.dist : "Select District"}</Option>
        ...
        <ContainerBox>
          ...
          <Option>{this.state.vnue ? this.state.vnue : "Select Venue"}</Option>
        ...
        <Input type="text" placeholder="Address" name="instAddr" value={this.state.instAddr} onChange={this.handleChange} required autocomplete/>
